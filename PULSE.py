...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1YUZZHNgphyOa1BfbxPBOPdfOOnS5CyV2", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1pnh91MlNhoSbvHuoivobIDMHq3zbbEmm", cache_dir=cache_dir, verbose=verbose) as f:
